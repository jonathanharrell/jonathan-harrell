...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>ſinful ſingular</p>
				<p style="font-feature-settings: 'hlig' 1;">
	...
	css={`
		@font-face {
			font-family: "cardo";
			src: url("https://60283105303ad00007a7f457--jonathan-harrell.netlify.app/fonts/cardo-regular.woff2");
		}
		body {
...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>Georg Duffner - Principal Design</p>
				<p style="font-feature-settings: 'pcap' 1;">
					G<span style="color: var(--primary-color);">eorg Duffner</span> - P<span style="color: var(--primary-color);">rincipal Design</span>
				</p>
			</div>
		</div>
	`}
	css={`
		@font-face {
			...
			src: url("https://60283105303ad00007a7f457--jonathan-harrell.netlify.app/fonts/eb-garamond-bold.woff2");
		}
		body {
...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>Georg Duffner - Principal Design</p>
				<p style="font-feature-settings: 'c2pc' 1; color: var(--primary-color);">
...
<Codepen
	...
	css={`
		@font-face {
			...
			src: url("https://60283105303ad00007a7f457--jonathan-harrell.netlify.app/fonts/arial-bold.woff2");
		}
		body {
...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>Quick brown lazy Grumpy</p>
				<p style="font-feature-settings: 'titl' 1;">
					Q<span style="color: var(--primary-color);">u</span>ick b<span style="color: var(--primary-color);">r</span>own laz<span style="color: var(--primary-color);">y</span> G<span style="color: var(--primary-color);">ru</span>mp<span style="color: var(--primary-color);">y</span>
				</p>
			</div>
		</div>
	`}
	css={`
		@font-face {
			font-family: "allan";
			src: url("https://60283105303ad00007a7f457--jonathan-harrell.netlify.app/fonts/allan-regular.woff2");
		}
		body {
...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>1 3/4 C of flour, 1/2 cup.</p>
				<p>1 <span style="font-feature-settings: 'afrc' 1; color: var(--primary-color);">3/4</span> C of flour, <span style="font-feature-settings: 'afrc' 1; color: var(--primary-color);">1/2</span> cup.</p>
			</div>
		</div>
	`}
	css={`
		@font-face {
			...
			src: url("https://60283105303ad00007a7f457--jonathan-harrell.netlify.app/fonts/ubuntu-mono-bold.woff2");
		}
		body {
			font-family: "ubuntu-mono-bold", sans-serif;
			font-weight: 600;
		}
		p {
			margin: 1.5rem;
...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>A paradise lost</p>
				<p style="font-feature-settings: 'hist' 1;">
					A paradi<span style=" color: var(--primary-color);">s</span>e lo<span style=" color: var(--primary-color);">s</span>t
				</p>
			</div>
		</div>
	`}
...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>Easy Sunday morning & my fox.</p>
				<p style="font-feature-settings: 'salt' 1;">
					E<span style="color: var(--primary-color);">a</span>s<span style="color: var(--primary-color);">y</span> Sund<span style="color: var(--primary-color);">ay</span> mornin<span style="color: var(--primary-color);">g</span> & m<span style="color: var(--primary-color);">y</span> fox.
				</p>
			</div>
		</div>
	`}
	...
	html={`
		<div class="wrap">
			<div>
				...
				<p style="font-feature-settings: 'ss01' 1;">
					T<span style="color: var(--primary-color);">h</span>e q<span style="color: var(--primary-color);">ui</span>c<span style="color: var(--primary-color);">k</span> <span style="color: var(--primary-color);">br</span>ow<span style="color: var(--primary-color);">n</span> fox
				</p>
			</div>
		</div>
	`}
...
<Codepen
	...
	html={`
		<div class="wrap">
			<div>
				<p>Fred And Ginger</p>
				<p style="font-feature-settings: 'swsh' 1;">
					<span style="color: var(--primary-color);">F</span>red <span style="color: var(--primary-color);">And G</span>inger
				</p>
			</div>
		</div>
	`}
