...
![True subscript characters are sized and positioned specifically for use in footnotes and scientific formulas.](/img/subscript.svg)
...
![True superscript characters are sized and positioned specifically for use in mathematical expressions and scientific formulas.](/img/superscript.svg)
...
![Small caps in the typeface Hoefler Text match the x-height of the font.](/img/small-caps.svg)
...
![All characters in the typeface Hoefler Text are converted to small caps using all-small-caps.](/img/all-small-caps.svg)
...
![Lining numerals in the typeface Ideal Sans stretch from baseline to cap-height.](/img/lining-nums.svg)
...
![Old-style numerals in the typeface Ideal Sans ascend and descend to sympathize with the rhythm of lowercase letters.](/img/oldstyle-nums.svg)
...
![Tabular numerals should be used in contexts where numbers need to be stacked.](/img/tabular-nums.svg)
...
![Numerators and denominators in the typeface Ideal Sans are aligned with the baseline and cap-height.](/img/diagonal-fractions.svg)
...
![The typeface Fedra Sans includes specially sized and positioned characters for common ordinals like "1st", "2nd", and "3rd".](/img/ordinals.svg)
...
![The typeface Operator Mono includes a special slashed-zero numeral.](/img/slashed-zero.svg)
