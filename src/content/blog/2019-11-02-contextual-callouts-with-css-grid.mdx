...
![CSS grid can be used to create a blog post layout that accommodates contextual callouts containing secondary information.](/img/css-grid-layout.svg "test title")
...
That wraps up this one. [Check out the live experiment here](https://codepen.io/jonathanharrell/pen/QZwqar). I’d love to see what other people do with callouts!
