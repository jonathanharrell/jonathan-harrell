...
<Codepen>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<div>
					<input type="email" id="placeholder-shown" placeholder="Email address" class="input" autoComplete="off" onChange={() => {}} />
					<label htmlFor="placeholder-shown">Email address</label>
				</div>
			</form>
		</div>
	</div>
