...
<Codepen id="vVEexG">
	...
	.input {
		font-size: var(--hiq-font-size-large) !important;
	}
	.input:focus {
...
<figure>
	<img
		src="/img/input-disabled.svg"
		data-dark-src="/img/input-disabled-dark.svg"
		alt="Disabled inputs can be styled to appear dimmer than enabled inputs, letting the user know that these inputs cannot be interacted with."
	/>
</figure>
