...
<Codepen height={260} smHeight={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<div>
...
<Codepen height={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<div>
					<input type="email" id="placeholder-shown" placeholder="Type in me" class="input" autoComplete="off" onChange={() => {}} />
					<label htmlFor="placeholder-shown">Type in me</label>
				</div>
			</form>
		</div>
	</div>
		...
		<div className="wrap">
			<form>
				<fieldset>
					...
					<div class="radio">
						<input type="radio" name="season" id="spring" checked onChange={() => {}}></input>
						<label for="spring">Option 1</label>
					</div>
					<div class="radio">
						<input type="radio" name="season" id="summer" onChange={() => {}}></input>
						<label for="summer">Option 2</label>
					</div>
				</fieldset>
			</form>
		</div>
