...
<Codepen>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<div>
					<input type="email" id="placeholder-shown" placeholder="Email address" class="input" autoComplete="off" />
	...
	<div data-lang="css">{`
	:root {
		--hiq-input-invalid-border-color: #e3e5e8;
	}
	.wrap {
		display: flex;
		align-items: center;
		...
		<div className="wrap">
			<form>
				<fieldset>
					...
					<div class="radio">
						<input type="radio" name="season" id="spring" checked></input>
						<label for="spring">Option 1</label>
					</div>
					<div class="radio">
						<input type="radio" name="season" id="summer"></input>
