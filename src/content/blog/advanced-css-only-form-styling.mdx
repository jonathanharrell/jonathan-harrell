...
```html
<input type="email" value="Read-write value" onChange={() => {}}>
...
<Codepen title="Default Input Value" height={240} smHeight={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<fieldset>
...
<Codepen title="Checked Input Value" height={240} smHeight={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<fieldset>
