...
<Codepen title="Enabled & Disabled Inputs" height={260} smHeight={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<div>
					<label htmlFor="enabled">Email address (enabled)</label>
					<input type="email" id="enabled" placeholder="email@email.com" class="input" onChange={() => {}} />
				</div>
				<div>
...
<Codepen title="Read-Write & Read-Only Inputs" height={260} smHeight={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<div>
					<label htmlFor="read-write">Email address (read-write)</label>
					<input type="email" id="read-write" placeholder="email@email.com" value="my-email@email.com" class="input" onChange={() => {}} />
				</div>
				<div>
					<label htmlFor="read-only">Email address (read-only)</label>
...
<Codepen title="Placeholder-Shown" height={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<div>
					<input
						...
						onChange={() => {}}
					/>
					<label htmlFor="type-in-me">Type in me</label>
				</div>
			</form>
		</div>
	</div>
...
<Codepen title="Default Input Value" height={260} smHeight={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<fieldset>
					...
					<div class="radio">
						<input type="radio" name="options" id="option-1" checked onChange={() => {}}></input>
						<label for="option-1">Option 1</label>
					</div>
					<div class="radio">
						<input type="radio" name="options" id="option-2" onChange={() => {}}></input>
						<label for="option-2">Option 2</label>
					</div>
					<div class="radio">
						<input type="radio" name="options" id="option-3" onChange={() => {}}></input>
						<label for="option-3">Option 3</label>
					</div>
					<div class="radio">
						<input type="radio" name="options" id="option-4" onChange={() => {}}></input>
...
.radio input:default + label {
	background-color: #F3F4F6;
	border-radius: 9999px;
}
.dark .radio input:default + label {
...
<Codepen title="Checked Input Value" height={260} smHeight={180}>
	<div data-lang="html">
		<div className="wrap">
			<form>
				<fieldset>
					<legend>Options</legend>
					<div class="checkbox">
						<input type="checkbox" name="options" id="option-1" onChange={() => {}}></input>
						<label for="option-1">Option 1</label>
					</div>
					<div class="checkbox">
						<input type="checkbox" name="options" id="option-2" onChange={() => {}}></input>
						<label for="option-2">Option 2</label>
					</div>
					<div class="checkbox">
						<input type="checkbox" name="options" id="option-3" checked onChange={() => {}}></input>
						<label for="option-3">Option 3</label>
					</div>
					<div class="checkbox">
						<input type="checkbox" name="options" id="option-4" onChange={() => {}}></input>
						<label for="option-4">Option 4</label>
					</div>
				</fieldset>
			</form>
...
<Codepen title="Indeterminate Input Value" height={260} smHeight={220}>
	<div data-lang="js">{`
...
function setMasterState() {
	...
	const trueValues = checkboxes.map(checkbox => checkbox.checked).filter(value => value);
			...
			<form>
				<div class="master-option-wrap">
					<div class="checkbox master-option">
						<input type="checkbox" name="master-option" id="master-option" onChange={() => {}}></input>
						<label for="master-option">Master option</label>
					</div>
				</div>
				<fieldset>
					<div class="checkbox">
						<input type="checkbox" name="options" id="option-1" checked onChange={() => {}}></input>
						<label for="option-1">Option 1</label>
					</div>
					<div class="checkbox">
						<input type="checkbox" name="options" id="option-2" checked onChange={() => {}}></input>
						<label for="option-2">Option 2</label>
					</div>
					<div class="checkbox">
						<input type="checkbox" name="options" id="option-3" onChange={() => {}}></input>
						<label for="option-3">Option 3</label>
					</div>
				</fieldset>
			</form>
