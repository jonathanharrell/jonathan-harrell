...
![Using render props in React or scoped slots in Vue, we reuse the same basic search/select functionality to create two different components.](/img/autocomplete.svg)
...
![An additional component we can create that reuses the same core search/select functionality is a tag-like list.](/img/tag-list.svg)
...
<Codepen
	title="Reusabel React Search Select with Render Props"
	height={260}
	smHeight={180}
	html={`
		<div class="wrap">
