...
description: >-
  ...
  a user to select their preferred theme and persist that choice between
  sessions.
...
There are some cases where you may want to allow a user to manually change the theme, overriding what the app inherited from the system by default. Let’s look at how we might achieve this using our initially simpler example. We will need to add a theme toggle method that will update our theme state.
...
Thanks to improving browser support for the detection of system themes, it has never been easier to implement a theme for your application or website that responds to your user’s operating system theme. With a bit of extra code, you can also enable user-chosen theme overrides. This will go a long way in creating a more customizable and comfortable experience for your users.
