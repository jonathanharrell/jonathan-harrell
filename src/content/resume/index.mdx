...
history:
  job:
    - company: Vowel
      description: >-
        * Created and managed Vowel's React component library, including unit
        ...
        * Diagnosed frontend performance issues, including memory leaks caused
        by unnecessary React component renders
