...
history:
  job:
    - company: Vowel
      description: >-
        * Built AI interfaces that delivered auto-summarization of video
        conferences to users

        * Created and managed Vowel's React component library, made up of
        unit-tested components that were built in isolation using Storybook

        * Led the frontend development of several new product features in React
        and Typescript, including a clip video editor, commenting experience and
        metrics dashboard
