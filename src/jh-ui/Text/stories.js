      ...
      {({ theme }) => (
        <div style={{ width: '400px' }}>
          <Text theme={theme} order={order} element={element}>
            ...
            mollis rhoncus purus, varius iaculis purus rhoncus eget. Morbi lectus ligula, tempus sed est sit amet,
            pulvinar sodales nulla. Nunc at risus sodales, interdum quam ut, suscipit nisl. Proin sagittis, lacus ut
            tincidunt interdum, tellus est maximus est, at mollis ante urna id velit. Morbi laoreet in sapien sed
            posuere. Pellentesque malesuada sapien at euismod sodales. Aliquam malesuada ex diam, rhoncus venenatis
            augue iaculis et.
          </Text>
        </div>
      )}
